...
class SocialService extends ChangeNotifier {
    ...
    try {
      ...
      _posts = response.map((data) {
        ...
        return SocialPost(
          ...
          comments: comments.map((c) => (c as Map<String, dynamic>)['content'] as String).toList(),
    ...
    try {
      ...
      _familyGroups = response.map((data) {
        ...
        final members = (data['group_members'] as List? ?? [])
            .where((m) => (m as Map<String, dynamic>)['is_active'] == true)
  ...
  Future<bool> commentOnPost(
    ...
    try {
      ...
      final comments = (commentsResponse as List<dynamic>)
