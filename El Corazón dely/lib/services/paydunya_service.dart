...
class PayDunyaService extends ChangeNotifier {
  ...
  // NOTE: le host `app-sandbox.paydunya.com` peut ne pas résoudre (DNS/ENOTFOUND).
  ...
  Future<void> initialize({
    ...
    _isSandbox = isSandbox ?? ApiConfig.payDunyaIsSandbox;
    _isInitialized = true;

    debugPrint(
      'PayDunyaService: Initialisé en mode ${_isSandbox ? "sandbox" : "production"}',
    );
    notifyListeners();
  }
