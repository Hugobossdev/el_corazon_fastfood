...
class _DriverRegistrationScreenState extends State<DriverRegistrationScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title:
                  Text(l10n?.chooseFromGallery ?? 'Choisir depuis la galerie'),
              onTap: () {
                Navigator.pop(context);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      validator: (value) => Validators.validateRequired(
                          value, 'votre numéro de carte d\'identité'),
                    ),
                    const SizedBox(height: AppSpacing.xl),
                    ...
                    CustomTextField(
                      ...
                      validator: (value) => Validators.validateRequired(
                          value, 'le numéro de votre véhicule'),
                    ),
                    const SizedBox(height: AppSpacing.xl),
  ...
  Widget _buildPhotoSection(
      String title, io.File? photo, String type, AppLocalizations l10n) {
