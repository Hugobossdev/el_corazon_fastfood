...
class AddressService extends ChangeNotifier {
  ...
  Future<Address> addAddress({
    ...
    try {
      ...
      if (finalLatitude == null || finalLongitude == null) {
        final fullAddress = '$address, $city${postalCode.isNotEmpty ? ', $postalCode' : ''}';
        debugPrint('AddressService: Géocodage automatique de l\'adresse: $fullAddress');
        ...
        try {
          ...
          if (coords != null) {
            ...
            debugPrint('AddressService: Coordonnées obtenues - lat: $finalLatitude, lng: $finalLongitude');
          } else {
            debugPrint('⚠️ AddressService: Impossible de géocoder l\'adresse: $fullAddress');
  ...
  Future<Address> updateAddress({
    ...
    try {
      ...
      final addressChanged = (address != null && address != currentAddress.address) ||
                            (city != null && city != currentAddress.city) ||
                            (postalCode != null && postalCode != currentAddress.postalCode);
      
      final coordinatesMissing = (finalLatitude == null || finalLongitude == null) &&
                                (currentAddress.latitude == null || currentAddress.longitude == null);
      
      if ((addressChanged || coordinatesMissing) && (finalLatitude == null || finalLongitude == null)) {
        final fullAddress = '$finalAddress, $finalCity${finalPostalCode.isNotEmpty ? ', $finalPostalCode' : ''}';
        debugPrint('AddressService: Géocodage automatique lors de la mise à jour: $fullAddress');
