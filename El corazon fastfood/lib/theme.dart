...
class AppColors {
  ...
  // Gradient rouge uni pour Menu Signature (rouge principal avec légère variation)
  static const primaryGradient = [
    Color(0xFFE53E3E),
    Color(0xFFE53E3E),
  ];
  // Gradient jaune doré uni pour Livraison (comme dans l'interface)
  static const secondaryGradient = [
    Color(0xFFF6D55C),
    Color(0xFFF6D55C),
  ];
  // Gradient orange-jaune pour Récompenses (comme la carte de fidélité: orange en haut, jaune en bas)
  static const successGradient = [
    Color(0xFFFF8A50), // Orange en haut
    Color(0xFFF6D55C), // Jaune doré en bas
  ];
