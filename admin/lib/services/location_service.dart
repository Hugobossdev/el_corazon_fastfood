...
class LocationService extends ChangeNotifier {
  ...
  void generateDeliveryRoute(
      Map<String, double> restaurant, Map<String, double> destination) {
    _deliveryRoute = [
      restaurant,
      {
        'latitude': restaurant['latitude']! + 0.001,
        'longitude': restaurant['longitude']! + 0.0005
      },
      {
        'latitude': restaurant['latitude']! + 0.002,
        'longitude': restaurant['longitude']! + 0.001
      },
      {
    ...
    return [
      ...
      },
      {
        ...
        'position': {
          ...
          'longitude': userLocation.longitude - 0.009
        },
        'rating': 4.7,
